...
BEGIN
  ...
  INSERT INTO Patient_Log  (P_NHS_number_OLD, P_NHS_number_NEW, P_first_name_OLD, P_first_name_NEW,
                            ...
                            P_date_of_birth_OLD, P_date_of_birth_NEW, P_postcode_OLD, P_postcode_NEW, SQL_action, TimeEnter)
...
BEGIN
  ...
  INSERT INTO Patient_Log  (P_NHS_number_NEW, P_first_name_NEW,
                            ...
                            P_date_of_birth_NEW, P_postcode_NEW, SQL_action, TimeEnter)
...
BEGIN
  ...
  INSERT INTO Patient_Log  (P_NHS_number_OLD, P_first_name_OLD,
                            ...
                            P_date_of_birth_OLD, P_postcode_OLD, SQL_action, TimeEnter)
