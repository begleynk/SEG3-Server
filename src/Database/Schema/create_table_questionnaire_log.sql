...
BEGIN
  ...
  INSERT INTO Questionnaire_Log  (Q_id_OLD, Q_id_NEW, Q_title_OLD, Q_title_NEW,
                            Q_state_OLD, Q_state_NEW, SQL_action, TimeEnter)
...
BEGIN
  ...
  INSERT INTO Questionnaire_Log  (Q_id_NEW, Q_title_NEW,
                            Q_state_NEW, SQL_action, TimeEnter)
...
BEGIN
  ...
  INSERT INTO Questionnaire_Log  (Q_id_OLD, Q_title_OLD, Q_state_OLD, SQL_action, TimeEnter)
